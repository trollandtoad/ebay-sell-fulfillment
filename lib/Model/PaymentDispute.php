...
class PaymentDispute implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets line_items
     *
     * @param \eBay\Sell\Fulfillment\Model\OrderLineItems[]|null $line_items This array is used to identify one or more order line items associated with the payment dispute. There will always be at least one itemId/lineItemId pair returned in this array.
     *
     * @return self
     */
