...
class LineItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets taxes
     *
     * @param \eBay\Sell\Fulfillment\Model\Tax[]|null $taxes Contains a list of taxes applied to the line item, if any. This array is always returned, but will be returned as empty if no taxes are applicable to the line item, or if the seller is opted in to eBay managed payments.
     *
     * @return self
     */
