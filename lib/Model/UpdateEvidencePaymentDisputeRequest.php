...
class UpdateEvidencePaymentDisputeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets files
     *
     * @param \eBay\Sell\Fulfillment\Model\FileEvidence[]|null $files This array is used to specify one or more evidence files that will be added to the evidence set associated with a payment dispute. At least one evidence file must be specified in the files array. The unique identifier of an evidence file is returned in the response payload of the uploadEvidence method.
     *
     * @return self
     */
     ...
     * Sets line_items
     *
     * @param \eBay\Sell\Fulfillment\Model\OrderLineItems[]|null $line_items This required array identifies the order line item(s) for which the evidence file(s) will be applicable. Both the itemId and lineItemID fields are needed to identify each order line item, and both of these values are returned under the evidenceRequests.lineItems array in the getPaymentDispute response.
     *
     * @return self
     */
